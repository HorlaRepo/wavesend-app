...
export function getTransactionById(http: HttpClient, rootUrl: string, params: GetTransactionById$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseTransactionResponse>> {
